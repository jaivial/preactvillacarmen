...
const DICT: Dictionary = {
  ...
  'nav.coffees': { es: 'Cafes', en: 'Coffees' },
  'nav.beverages': { es: 'Bebidas', en: 'Beverages' },
  ...
  'menu.cafes.subtitle': { es: 'Café, infusiones y chocolates.', en: 'Coffee, teas, and hot chocolate.' },
  'menu.bebidas.subtitle': { es: 'Refrescos, cervezas y cócteles.', en: 'Soft drinks, beers, and cocktails.' },
  'cafe_type.CAFE': { es: 'Café', en: 'Coffee' },
  'cafe_type.INFUSION': { es: 'Infusión', en: 'Tea' },
  'cafe_type.CHOCOLATE': { es: 'Chocolate', en: 'Hot Chocolate' },
  'cafes.error': { es: 'No se pudo cargar la carta de cafés.', en: 'Could not load coffee list.' },
  'cafes.empty': { es: 'No hay cafés disponibles.', en: 'No coffees available.' },
  'bebidas.error': { es: 'No se pudo cargar la carta de bebidas.', en: 'Could not load beverage list.' },
  'bebidas.empty': { es: 'No hay bebidas disponibles.', en: 'No beverages available.' },
